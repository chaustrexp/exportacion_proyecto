...
$routes = [
    ...
    'asignacion' => [
        ...
        'actions' => [
            'index', 'crear', 'store', 'ver', 'editar', 'update', 'eliminar',
            'getFormData', 'getAsignacion', 'getCalendar',
            // CU-01/02/03 AJAX endpoints
            'validarInstructor', 'getCompetenciasPendientes', 'checkAmbiente'
        ],
        'action_map' => [
            'create' => 'crear',
            'show'   => 'ver',
