...
<div class="main-content">
    <div style="max-width: 800px; margin: 0 auto; padding: 32px;">
        ...
        <div style="margin-bottom: 32px;">
            <h1 style="font-size: 28px; font-weight: 700; color: #1f2937; margin: 0 0 8px;">Editar Centro de Formación</h1>
            <p style="font-size: 14px; color: #6b7280; margin: 0;">Actualiza la información del centro</p>
        </div>
        ...
        <div style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 32px;">
            <form method="POST" action="<?php echo BASE_PATH; ?>centro_formacion/editar/<?php echo $registro['cent_id']; ?>">
                ...
                <div style="margin-bottom: 24px;">
                    ...
                    <input 
                        type="text" 
                        value="<?php echo htmlspecialchars($registro['cent_id']); ?>" 
                        disabled
                ...
                <div style="margin-bottom: 24px;">
                    ...
                    <input 
                        ...
                        name="cent_nombre" 
                        class="form-control" 
                        value="<?php echo htmlspecialchars($registro['cent_nombre']); ?>"
                        required
