                ...
                <select name="COMPETxPROGRAMA_PROGRAMA_prog_id" class="form-control" required>
                    ...
                    <?php foreach ($programas as $programa): ?>
                        <option value="<?php echo safeHtml($programa, 'prog_codigo'); ?>"
                            <?php echo (safe($registro, 'COMPETxPROGRAMA_PROGRAMA_prog_id') == safe($programa, 'prog_codigo') || safe($registro, 'prog_id') == safe($programa, 'prog_codigo')) ? 'selected' : ''; ?>>
                ...
                <select name="COMPETxPROGRAMA_COMPETENCIA_comp_id" class="form-control" required>
                    ...
                    <?php foreach ($competencias as $competencia): ?>
                        <option value="<?php echo safeHtml($competencia, 'comp_id'); ?>"
                            <?php echo (safe($registro, 'COMPETxPROGRAMA_COMPETENCIA_comp_id') == safe($competencia, 'comp_id') || safe($registro, 'comp_id') == safe($competencia, 'comp_id')) ? 'selected' : ''; ?>>
